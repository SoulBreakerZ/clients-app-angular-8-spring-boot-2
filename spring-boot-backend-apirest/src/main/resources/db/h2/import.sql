...
INSERT INTO CLIENT(name,last_name,email,created_date,region_id) VALUES('Andres','Antivilo','andres.antivilo@gmail.com',NOW(),1);
...
INSERT INTO USER(username,password,enabled) VALUES('andres','$2a$10$TIC33rNONDolFsxYvE4g.uVjivyLuJDIkZxJ/M34y/oKrOr/DRIry',1);
INSERT INTO USER(username,password,enabled) VALUES('admin','$2a$10$f1MbMZHHC5HndHLdwYbg8eDtZPoTV7Nf3/YVydLHmTFLoHjM/tytC',1);
